(function (global, factory) {
	...
	(global.runOnServerClient = factory());
	...
	if (commonjsGlobal.XMLHttpRequest && typeof jest === "undefined") {
	  module.exports = commonjsGlobal.XMLHttpRequest;
	} else {
	...
	var fetchJSON_1 = createCommonjsModule(function (module, exports) {
	...
	function fetchJSON(method, url, data) {
	  ...
	  try {
	    var xhr$$1 = new xhr();
	    xhr$$1.open(method, url, !sync);

	    if (!sync) {
	      xhr$$1.timeout = 30000;
	    }

	    xhr$$1.onload = xhr$$1.onreadystatechange = function (event) {
	      if (xhr$$1.readyState === 4) {
	        resolve(xhr$$1.responseText);
	      }
	    };

	    xhr$$1.onerror = function (event) {
	      handleError(new Error(xhr$$1.statusText));
	    };

	    xhr$$1.setRequestHeader("Content-Type", "application/json");
	    xhr$$1.setRequestHeader("Accept", "application/json");
	    xhr$$1.send((0, _stringify2.default)(data));

	    var returnValue = void 0;
	    if (sync) {
	      returnValue = JSON.parse(xhr$$1.responseText);
	    } else {
	...
	unwrapExports(fetchJSON_1);

	var createClient = createCommonjsModule(function (module) {
	...
	var _fetchJSON2 = _interopRequireDefault(fetchJSON_1);
	...
	unwrapExports(createClient);

	var dist = createClient;
